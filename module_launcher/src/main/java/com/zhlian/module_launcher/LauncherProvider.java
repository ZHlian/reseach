...
import com.zhlian.module_launcher.R;
import com.zhlian.module_launcher.LauncherSettings.Favorites;
...
public class LauncherProvider extends ContentProvider {
    ...
    static final String AUTHORITY = "com.zhlian.module_launcher.settings";
    ...
    private static final String RESTRICTION_LAYOUT_NAME =
            "com.zhlian.module_launcher.workspace.configuration.layout.name";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
            ...
            try {
                ...
                while (((type = parser.next()) != XmlPullParser.END_TAG ||
                    ...
                    if (TAG_FAVORITE.equals(name)) {
                        ...
                        String title;
                        int titleResId =  a.getResourceId(R.styleable.Favorite_className, -1);
                        if (titleResId != -1) {
        ...
        private long addUriShortcut(SQLiteDatabase db, ContentValues values,
            ...
            final int titleResId = a.getResourceId(R.styleable.Favorite_icon, 0);
