...
import com.zhlian.module_launcher.InstallWidgetReceiver.WidgetMimeTypeHandlerData;
...
//        Collections.sort(widgetsAndShortcuts, newWidgetAndShortcutNameComparator(packageManager));
