 ...
 *
 * Not to be confused with {@link com.zhlian.module_launcher3.ShortcutInfo}.
 */
@TargetApi(Build.VERSION_CODES.N)
public class ShortcutInfoCompat {
    private static final String INTENT_CATEGORY = "com.zhlian.module_launcher3.DEEP_SHORTCUT";
